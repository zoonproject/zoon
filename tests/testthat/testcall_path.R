...
test_that('Test call_path in a large number of variations', {
  ...
  CP_work <- workflow(occurrence = list(UKAnophelesPlumbeus, NaiveRandomPresence),
                      covariate  = UKAir,
  ...
  expect_equal(attr(Process(CP_work)[[2]], 'call_path'),
               structure(list(occurrence = "NaiveRandomPresence", covariate = "UKAir", process = "Background"),
                         .Names = c("occurrence", "covariate", "process")))
  ...
  expect_equal(attr(Output(CP_work)[[2]], 'call_path'),
               structure(list(occurrence = "NaiveRandomPresence", covariate = "UKAir", process = "Background", model = "RandomForest", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
                            
  CP_worka <- workflow(occurrence = Chain(UKAnophelesPlumbeus, NaiveRandomPresence),
                       covariate  = UKAir,
                       process    = Background(n=70),
                       model      = RandomForest,
                       output     = PrintMap)
  ...
  expect_equal(attr(Process(CP_worka), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Background"),
                         .Names = c("occurrence", "covariate", "process")))
  expect_equal(attr(Model(CP_worka), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Background", model = "RandomForest"),
                         .Names = c("occurrence", "covariate", "process", "model")))
  expect_equal(attr(Output(CP_worka), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Background", model = "RandomForest", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
  ...
  CP_work1 <- workflow(occurrence = Chain(UKAnophelesPlumbeus, NaiveRandomPresence),
                       covariate  = UKAir,
  ...
  expect_equal(attr(Process(CP_work1)[[1]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "OneHundredBackground"),
                         .Names = c("occurrence", "covariate","process")))
  expect_equal(attr(Process(CP_work1)[[2]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Background"),
                         .Names = c("occurrence","covariate", "process")))
  expect_equal(attr(Model(CP_work1)[[1]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "OneHundredBackground", model = "RandomForest"),
                         .Names = c("occurrence", "covariate", "process", "model")))
  expect_equal(attr(Model(CP_work1)[[2]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Background", model = "RandomForest"),
                         .Names = c("occurrence", "covariate", "process", "model")))
  expect_equal(attr(Output(CP_work1)[[1]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "OneHundredBackground", model = "RandomForest", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
  ...
  CP_work1a <- workflow(occurrence = Chain(UKAnophelesPlumbeus, NaiveRandomPresence),
                        covariate  = UKAir,
  ...
  expect_equal(attr(Process(CP_work1a), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)"),
                         .Names = c("occurrence", "covariate","process")))
  expect_equal(attr(Model(CP_work1a), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)", model = "RandomForest"),
                         .Names = c("occurrence", "covariate", "process", "model")))
  expect_equal(attr(Output(CP_work1a), 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)", model = "RandomForest", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
  

  CP_work3 <- workflow(occurrence = Chain(UKAnophelesPlumbeus, NaiveRandomPresence),
                       covariate  = UKAir,
                       process    = Chain(NoProcess, Background(n=70)),
  ...
  expect_equal(attr(Model(CP_work3)[[2]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)", model = "LogisticRegression"),
                         .Names = c("occurrence", "covariate","process","model")))
  expect_equal(attr(Output(CP_work3)[[1]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)", model = "RandomForest", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
  expect_equal(attr(Output(CP_work3)[[2]], 'call_path'),
               structure(list(occurrence = "Chain(UKAnophelesPlumbeus, NaiveRandomPresence)", covariate = "UKAir", process = "Chain(NoProcess, Background)", model = "LogisticRegression", output = "PrintMap"),
                         .Names = c("occurrence", "covariate", "process", "model", "output")))
