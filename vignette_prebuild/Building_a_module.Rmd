...
```{r building_occ6, fig.width = 5, fig.height = 5, warning = FALSE}
...
```{r building_cov4, fig.width = 5, fig.height = 5, message = FALSE, warning = FALSE}
...
```{r building_pro5, message = FALSE, warning = FALSE}
...
```{r building_mod7, warning=FALSE, message=FALSE}
...
```{r building_out1, warning = FALSE, eval = FALSE}
# We run a very simple workflow so that we can get example input
# for our module
...
```{r building_out7, message = FALSE, warning = FALSE}
