...
##  [4] MASS_7.3-45         SDMTools_1.1-221    knitr_1.13         
##  [7] zoon_0.5            testthat_1.0.2      randomForest_4.6-12
## [10] dismo_1.0-15        raster_2.5-2        sp_1.2-3           
## 
...
## [13] rbison_0.4.8      ggplot2_2.1.0     lazyeval_0.1.10  
## [16] curl_0.9.7        rstudioapi_0.5    data.table_1.9.6 
## [19] whisker_0.3-2     R.utils_2.3.0     R.oo_1.20.0      
## [22] oai_0.2.0         rmarkdown_0.9.6   devtools_1.11.1  
## [25] rgdal_1.1-9       stringr_1.0.0     RCurl_1.95-4.8   
## [28] munsell_0.4.3     httpuv_1.3.3      rgeos_0.3-19     
## [31] htmltools_0.3.5   geoaxe_0.1.0      tibble_1.0       
## [34] roxygen2_5.0.1    codetools_0.2-14  XML_3.98-1.4     
## [37] rgbif_0.9.3       crayon_1.3.1      dplyr_0.4.3      
## [40] withr_1.0.1       bitops_1.0-6      R.methodsS3_1.7.1
## [43] grid_3.3.0        jsonlite_0.9.20   gtable_0.2.0     
## [46] DBI_0.4-1         magrittr_1.5      formatR_1.4      
## [49] scales_0.4.0      stringi_1.0-1     mapproj_1.2-4    
## [52] ridigbio_0.3.3    rebird_0.3.0      xml2_0.1.2       
## [55] rfigshare_0.3.7   iterators_1.0.8   tools_3.3.0      
## [58] RJSONIO_1.3-0     maps_3.1.0        rsconnect_0.4.2.2
## [61] parallel_3.3.0    yaml_2.1.13       colorspace_1.2-6 
## [64] memoise_1.0.0
```
...
```
## auc :  0.849635960747072
```

```
## kappa :  0.493006993006993
```

```
## omissions :  0.205128205128205
```

```
## sensitivity :  0.794871794871795
```

```
## specificity :  0.740740740740741
```

```
## proportionCorrect :  0.758333333333333
```
