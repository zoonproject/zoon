...
## 	C:\Users\tomaug\AppData\Local\Temp\Rtmpw5yd18\downloaded_packages
```
...
## [4] knitr_1.13          zoon_0.4.27         raster_2.5-2       
## [7] sp_1.2-3           
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.4       formatR_1.4       plyr_1.8.3       
##  [4] R.methodsS3_1.7.1 R.utils_2.3.0     bitops_1.0-6     
##  [7] tools_3.3.0       testthat_1.0.2    digest_0.6.9     
## [10] memoise_1.0.0     evaluate_0.9      rfigshare_0.3.7  
## [13] gtable_0.2.0      lattice_0.20-33   yaml_2.1.13      
## [16] rgdal_1.1-9       withr_1.0.1       httr_1.1.0       
## [19] stringr_1.0.0     roxygen2_5.0.1    devtools_1.11.1  
## [22] grid_3.3.0        R6_2.1.2          XML_3.98-1.4     
## [25] RJSONIO_1.3-0     ggplot2_2.1.0     magrittr_1.5     
## [28] scales_0.4.0      colorspace_1.2-6  httpuv_1.3.3     
## [31] stringi_1.0-1     RCurl_1.95-4.8    munsell_0.4.3    
## [34] crayon_1.3.1      R.oo_1.20.0
```
...
```
## also installing the dependencies 'rbison', 'rebird', 'rvertnet', 'ridigbio', 'lubridate', 'tibble'
```
...
## package 'ridigbio' successfully unpacked and MD5 sums checked
...
```
## specificity :  0.987654320987654
```

```
## proportionCorrect :  0.666666666666667
```
...
```
## auc :  0.87480215257993
```

```
## kappa :  0.683377308707124
```

```
## omissions :  0.0769230769230769
```

```
## sensitivity :  0.923076923076923
```
