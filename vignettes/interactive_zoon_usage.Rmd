...
```
## Warning in ExtractAndCombData(x, covariate.output[[1]]): Some extracted
## covariate values are NA. This may cause issues for some models
```
...
```
## Warning in ExtractAndCombData(oc, cov): Some extracted covariate values are
## NA. This may cause issues for some models
```
